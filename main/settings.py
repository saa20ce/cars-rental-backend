...
SECRET_KEY = 'django-insecure-ruk7%$qmdr7#chy_ky#k851c-c-sxj&w2+7n0%iqggd3ihj=ps'
...
CSRF_TRUSTED_ORIGINS = os.environ.get("DJANGO_CSRF_TRUSTED", "").split(",") if not DEBUG else []
